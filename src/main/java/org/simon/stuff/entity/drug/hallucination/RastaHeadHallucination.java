...
import org.simon.stuff.client.render.RastaHeadModel;
...
public class RastaHeadHallucination extends AbstractEntityHallucination {
    private static final Identifier TEXTURE = Stuff.id("textures/drug/cannabis/rasta_head_hallucination.png");
